...
<div class="card" data-aos="fade-right">
    ...
    <form action="{{ route('transaksi.store') }}" method="POST" id="formTransaksi">
        ...
        <div>
            ...
            <p>Diskon: Rp <span id="diskonDisplay">0</span>
               <span id="diskonKeterangan" style="font-size:0.85rem;color:#16a34a;"></span>
            </p>
...
// Fungsi hitung total + diskon + keterangan
function hitungTotal(){
    ...
    let diskon=0;
    if(totalItem>5){
        let diskonPersen = subtotal*0.2;
        diskon += diskonPersen;
        keteranganDiskon.push("Diskon 20% (Jumlah item > 5)");
    }
    if(subtotal>100000){
        diskon += 20000;
        keteranganDiskon.push("Diskon Rp 20.000 (Total > 100.000)");
    }
    ...
    document.getElementById('diskonKeterangan').innerText = keteranganDiskon.join(", ");
